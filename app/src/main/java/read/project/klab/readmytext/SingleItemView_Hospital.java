...
public class SingleItemView_Hospital extends Activity {
    // Declare Variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        IMGToSpeech.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mytitle.equals("ndarwaye")) {
                    // Play song
                    mp.reset();// stops any current playing song
                    mp = MediaPlayer.create(getApplicationContext(), R.raw.ndarwaye);// create's
                    mp.start(); // starting mediaplayer

                }  else if(mytitle.equals("navunitse hano")) {
                    // Play song
                    mp.reset();// stops any current playing song
                    mp = MediaPlayer.create(getApplicationContext(), R.raw.navunitsehano);// create's
                    mp.start(); // starting mediaplayer
                ...
                } else if(mytitle.equals("sinabibasha")) {
                    // Play song
                    mp.reset();// stops any current playing song
                    mp = MediaPlayer.create(getApplicationContext(), R.raw.sinabibasha);// create's
                    mp.start(); // starting mediaplayer
