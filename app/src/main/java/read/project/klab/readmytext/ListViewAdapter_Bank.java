...
public class ListViewAdapter_Bank extends BaseAdapter {
	...
	public ListViewAdapter_Bank(Context context, List<WorldPopulation> worldpopulationlist) {
		mContext = context;
		...
		// Listen for ListView Item Click
			...
			public void onClick(View arg0) {
                ...
                if(mytitle.equals("kubikuza")) {
                    ...
                    Intent intent = new Intent(mContext, SingleItemView_Bank.class);
                    ...
                    mp = MediaPlayer.create(mContext, R.raw.kubikuza);// create's
                    ...
                    // Play song
                    mp.reset();// stops any current playing song
                    mp = MediaPlayer.create(mContext, R.raw.kubitsa);// create's
                    mp.start(); // starting mediaplayer
                    ...
                    // Play song
                    mp.reset();// stops any current playing song
                    mp = MediaPlayer.create(mContext, R.raw.ntakonegisiyoihari);// create's
                    mp.start(); // starting mediaplayer
                    ...
                    // Play song
                    mp.reset();// stops any current playing song
                    mp = MediaPlayer.create(mContext, R.raw.ndasabainguzanyo);// create's
                    mp.start(); // starting mediaplayer
