...
public class SingleItemView_Shop extends Activity {
    // Declare Variables
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        IMGToSpeech.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              if(mytitle.equals("urashaka iki")) {
                  // Play song
                  mp.reset();// stops any current playing song
                  mp = MediaPlayer.create(getApplicationContext(), R.raw.urashakaiki);// create's
                  mp.start(); // starting mediaplayer

              }
              if(mytitle.equals("ndishyura angahe")) {
               ...
               if(mytitle.equals("mungarurire")) {
                  // Play song
                  mp.reset();// stops any current playing song
                  mp = MediaPlayer.create(getApplicationContext(), R.raw.mungarurire);// create's
                  mp.start(); // starting mediaplayer

              }
                 if(mytitle.equals("yego")) {
                    // Play song
                    mp.reset();// stops any current playing song
