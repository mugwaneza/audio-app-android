...
public class ListViewAdapter_Shop extends BaseAdapter {
	...
	public ListViewAdapter_Shop(Context context, List<WorldPopulation> worldpopulationlist) {
		mContext = context;
	...
	public View getView(final int position, View view, ViewGroup parent) {
		...
		// Listen for ListView Item Click
			...
			public void onClick(View arg0) {
                ...
                if(mytitle.equals("mwiriwe")) {
                    // Play song

                    Intent intent = new Intent(mContext, SingleItemView_Shop.class);
                ...
                }else if(mytitle.equals("urashaka iki")) {
                    ...
                    mContext.startActivity(intent);
                    mp.reset();// stops any current playing song
                    mp = MediaPlayer.create(mContext, R.raw.urashakaiki);// create's
                    mp.start(); // starting mediaplayer
                ...
                else if(mytitle.equals("mungarurire")) {
                    ...
                    // Play song
                    mp.reset();// stops any current playing song
                    mp = MediaPlayer.create(mContext, R.raw.mungarurire);// create's
                    mp.start(); // starting mediaplayer
